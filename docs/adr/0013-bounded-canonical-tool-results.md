...
> 已取代：[任务：ToolResult 基础设施重写为 Pi 形态](https://github.com/weiguangchao/susan/issues/96) 确立 Tool Result 为 Pi `{content, details}` + throw/isError；Canonical Tool Result envelope、错误码体系、nextArguments 与统一 JSON-byte budget 退役。以下保留原决策历史。
