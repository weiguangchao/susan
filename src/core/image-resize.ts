 ...
 * block the TUI event loop. If the worker cannot be loaded (for example in a
 * source TypeScript runtime without worker loader support), fall back to in-process resizing so image
 * reads still work.
 */
